...
public interface IKGraphRepository {
	 ...
	 */
	HashMap<String, Object> getdomaingraph1(GraphQuery query);
     ...
     * @return
     */
    HashMap<String, Object> getmorerelationnodeSec(String sourceName, String targetName);
     ...
     * @return
     */
    HashMap<String, Object> getDetail(String name);
}
