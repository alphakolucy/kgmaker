...
@Api(value = "数据库管理", description = "节点相关，提供节点的增删查改")
@Controller
...
public class KGManagerController extends BaseController {
    ...
    @ApiOperation("查询detail")
    @ResponseBody
    @PostMapping(value = "/getDetail/{{name}}")
    public R<HashMap<String, Object>> getDetail(@PathVariable("{name}") String name) {

        R<HashMap<String, Object>> result = new R<HashMap<String, Object>>();
        try {
            HashMap<String, Object> graphData = KGGraphService.getDetail(name);
            result.code = 200;
    ...
    @ApiOperation("查询图谱节点和关系")
    @ResponseBody
    @PostMapping(value = "/getdomaingraph")
    public R<HashMap<String, Object>> getDomainGraph(GraphQuery query) {
        R<HashMap<String, Object>> result = new R<HashMap<String, Object>>();
        try {

//            String uuid = "392";
//            HashMap<String, Object> graphData = KGGraphService.getMoreRelationNode(query.getDomain(),uuid);
            HashMap<String, Object> graphData = KGGraphService.getdomaingraph1(query);
            result.code = 200;
            result.data = graphData;
...
//    @GetMapping(value = "/getMoreRelationNode/{domain}/{nodeid}")
    public R<HashMap<String, Object>> getmorerelationnode(String domain, String nodeid) {
//        public R<HashMap<String, Object>> getMoreRelationNode(@PathVariable("domain") String domain, @PathVariable("nodeid") String nodeid) {
        R<HashMap<String, Object>> result = new R<HashMap<String, Object>>();
        try {
            if (!StringUtil.isBlank(domain)) {
    ...
    public R<HashMap<String, Object>> getmorerelationnodeSec(@PathVariable("sourceName") String sourceName, @PathVariable("targetName") String targetName) {
        R<HashMap<String, Object>> result = new R<HashMap<String, Object>>();


        try {
            if (!StringUtil.isBlank(sourceName) && !StringUtil.isBlank(targetName)) {
                HashMap<String, Object> graphModel = KGGraphService.getmorerelationnodeSec(sourceName, targetName);
...
//    @ApiOperation(value = "关系查询（最短路径）")
//    @ResponseBody
//    @GetMapping(value = "/getBtnRelationship1/{sourceName}/{targetName}")
//    public R<HashMap<String, Object>> getmorerelationnodeSec1(@PathVariable("sourceName") String sourceName, @PathVariable("targetName") String targetName) {
//        R<HashMap<String, Object>> result = new R<HashMap<String, Object>>();
...
//    }
    ...
    public R<HashMap<String, Object>> batchcreatechildnode(String domain, String sourceid, Integer entitytype, String[] targetnames, String relation) {
        R<HashMap<String, Object>> result = new R<HashMap<String, Object>>();
        HashMap<String, Object> rss = new HashMap<String, Object>();
        try {
    ...
    public R<List<HashMap<String, Object>>> batchcreatesamenode(String domain, Integer entitytype, String[] sourcenames) {
